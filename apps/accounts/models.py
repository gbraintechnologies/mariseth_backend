...
from apps.shared.literals import (
    ADD_ADMIN, ADD_EMPLOYEE_DISCIPLINARY_ACTION, ADD_EMPLOYEE_QUALIFICATION,
    ADD_REMOVE_WAREHOUSE_MANAGER, ADD_TRAINING_ATTENDEE, APPROVE_DECLINE_LEAVE_REQUEST,
    APPROVE_INFLOW_DELIVERY_INSPECTION, APPROVE_INFLOW_ORDER, APPROVE_OR_DENY_CREDIT,
    ASSIGN_DELIVERY_INFO, CREATE_CREDIT, CREATE_CUSTOMER, CREATE_CUSTOM_TYPE,
    CREATE_DEPARTMENT, CREATE_EMPLOYEE, CREATE_FARM, CREATE_FARMER,
    CREATE_GROUPS_AND_ROLES, CREATE_HELP, CREATE_INFLOW_ORDER, CREATE_INPUT_CREDIT, CREATE_INPUT_CREDIT_PURCHASE,
    CREATE_JOB_TITLE,
    CREATE_LEAVE_REQUEST,
    CREATE_LEAVE_TYPE, CREATE_OR_UPDATE_SETTINGS, CREATE_OUTFLOW_ORDER, CREATE_PAYBACK,
    CREATE_PRODUCT, CREATE_TRAINING, CREATE_WAREHOUSE, DELETE_ADMIN, DELETE_CREDIT,
    DELETE_CUSTOMER, DELETE_CUSTOM_TYPE, DELETE_DEPARTMENT, DELETE_EMPLOYEE, DELETE_FARM,
    DELETE_FARMER, DELETE_FARM_PRODUCTS, DELETE_GROUPS_AND_ROLES, DELETE_HELP, DELETE_INFLOW_ORDER,
    DELETE_INPUT_CREDIT, DELETE_INPUT_CREDIT_PURCHASE, DELETE_JOB_TITLE, DELETE_LEAVE_REQUEST, DELETE_LEAVE_TYPE,
    DELETE_OUTFLOW_ORDER,
    DELETE_PRODUCT, DELETE_TRAINING, DELETE_WAREHOUSE, DOWNLOAD_INVOICE, DOWNLOAD_WAYBILL,
    GET_FARMER_CREDIT_HISTORY, GET_PRODUCT_MOVEMENT, GET_PRODUCT_WAREHOUSE_MOVEMENT,
    GET_SMALLHOLDERS_BY_LEAD, GET_WAREHOUSE_INVENTORY, LIST_ADMINS, LIST_CREDITS,
    LIST_CREDIT_FULFILL, LIST_CUSTOMERS, LIST_DEPARTMENTS, LIST_EMPLOYEES, LIST_EMPLOYEE_DISCIPLINARY_ACTIONS,
    LIST_EXPENSES, LIST_FARMERS, LIST_FARMS, LIST_INFLOW_APPROVALS, LIST_INFLOW_HISTORY, LIST_INFLOW_ORDERS,
    LIST_INPUT_CREDIT, LIST_INPUT_CREDIT_PURCHASE, LIST_INVOICES,
    LIST_JOB_TITLES, LIST_LEAVE_REQUESTS, LIST_LEAVE_TYPES, LIST_OUTFLOW_APPROVAL,
    LIST_OUTFLOW_HISTORY, LIST_OUTFLOW_ORDERS, LIST_PAYBACKS, LIST_PRODUCTS, LIST_TRAININGS,
    LIST_TRAINING_ATTENDEES, LIST_WAREHOUSES, LIST_WAYBILLS, MARK_OUTFLOW_COMPLETE,
    MARK_OUTFLOW_DELIVERED, MARK_OUTFLOW_ORDER_PICKED, MARK_TRAINING_ATTENDEE_PRESENT,
    RECORD_OUTFLOW_PAYMENT, REMOVE_EMPLOYEE_QUALIFICATION, REMOVE_TRAINING_ATTENDEE,
    SET_ATTENDANCE_STATUS, UPDATE_ADMIN, UPDATE_CREDIT, UPDATE_CUSTOMER, UPDATE_CUSTOM_TYPE, UPDATE_DEPARTMENT,
    UPDATE_EMPLOYEE, UPDATE_FARM, UPDATE_FARMER, UPDATE_GROUPS_AND_ROLES,
    UPDATE_HELP, UPDATE_INFLOW_ORDER, UPDATE_INPUT_CREDIT, UPDATE_JOB_TITLE, UPDATE_LEAVE_REQUEST, UPDATE_LEAVE_TYPE,
    UPDATE_OUTFLOW_ORDER, UPDATE_PAYBACK, UPDATE_PRODUCT, UPDATE_TRAINING,
    UPDATE_WAREHOUSE, UPLOAD_WAREHOUSES, VERIFY_OUTFLOW_AVAILABILITY, VIEW_CREDIT,
...
class User(AbstractUser, BaseModel, PermissionsMixin):
    ...
    class Meta:
        permissions = [
            ...
            (GET_FARMER_CREDIT_HISTORY, 'get farmer credit history'),
            ...
            (GET_PRODUCT_MOVEMENT, 'get product movement'),
            # (UPLOAD_PRODUCTS, ''),
            # credit
            ...
            (WAREHOUSE_MANAGER_FULFILL_CREDIT, 'fulfill a credit for a warehouse'),

            (LIST_CREDIT_FULFILL, 'list all credits to be fulfilled for a warehouse'),
            (CREATE_INPUT_CREDIT, 'create an input credit'),
            (UPDATE_INPUT_CREDIT, 'update an input credit'),
            (DELETE_INPUT_CREDIT, 'delete an input credit'),
            (VIEW_INPUT_CREDIT, 'view an input credit'),
            (LIST_INPUT_CREDIT, 'list all input credits'),
            (CREATE_INPUT_CREDIT_PURCHASE, 'create an input credit procurement'),
            (LIST_INPUT_CREDIT_PURCHASE, 'list all input credit procurements'),
            (DELETE_INPUT_CREDIT_PURCHASE, 'delete an input credit procurement'),
            ...
            (LIST_INFLOW_APPROVALS, 'list all inflow order approvals per warehouse manager'),
            (VIEW_INFLOW_APPROVAL, "view an inflow order approval per warehouse manager"),
            ...
            # outflow
            (CREATE_OUTFLOW_ORDER, 'create an outflow order'),
            (UPDATE_OUTFLOW_ORDER, 'update an outflow order'),
            (VIEW_OUTFLOW_ORDER, 'view an outflow order'),
            (DELETE_OUTFLOW_ORDER, 'delete an outflow order'),
            (LIST_OUTFLOW_ORDERS, 'list all outflow orders'),
            (MARK_OUTFLOW_DELIVERED, 'mark an outflow order as delivered'),
            (RECORD_OUTFLOW_PAYMENT, 'add payment to an outflow order'),
            (MARK_OUTFLOW_COMPLETE, 'mark an outflow order as complete'),
            (ASSIGN_DELIVERY_INFO, 'assign delivery info to an outflow order'),
            (VIEW_OUTFLOW_APPROVAL, 'view an outflow approval per warehouse manager'),
            ...
            (LIST_WAYBILLS, 'list all waybills'),
            (VIEW_WAYBILL, 'view a waybill'),
            (DOWNLOAD_WAYBILL, 'download waybill'),
            (LIST_INVOICES, 'list all invoices'),
            (VIEW_INVOICE, 'view a invoice'),
            (DOWNLOAD_INVOICE, 'download invoice'),

            (LIST_DEPARTMENTS, 'list all departments'),
            (CREATE_DEPARTMENT, 'create a department'),
            (VIEW_DEPARTMENT, 'view a department'),
            (UPDATE_DEPARTMENT, 'update a department'),
            (DELETE_DEPARTMENT, 'delete a department'),

            (LIST_JOB_TITLES, 'list all job titles'),
            (CREATE_JOB_TITLE, 'create a job title'),
            (VIEW_JOB_TITLE, 'view a job title'),
            (UPDATE_JOB_TITLE, 'update a job title'),
            (DELETE_JOB_TITLE, 'delete a job title'),
            ...
            (ADD_EMPLOYEE_QUALIFICATION, 'add qualification to an employee'),
            (REMOVE_EMPLOYEE_QUALIFICATION, 'remove qualification from an employee '),
            (ADD_EMPLOYEE_DISCIPLINARY_ACTION, 'record a disciplinary action for an employee'),
            (LIST_EMPLOYEE_DISCIPLINARY_ACTIONS, 'list all disciplinary actions for an employee'),

            (CREATE_LEAVE_TYPE, 'create a leave type'),
            (VIEW_LEAVE_TYPE, 'view a leave type'),
            (UPDATE_LEAVE_TYPE, 'update a leave type'),
            (LIST_LEAVE_TYPES, 'list all leave types'),
            (DELETE_LEAVE_TYPE, 'delete a leave type'),

            (CREATE_LEAVE_REQUEST, 'create a leave request'),
            (VIEW_LEAVE_REQUEST, 'view a leave request'),
            ...
            (APPROVE_DECLINE_LEAVE_REQUEST, 'approve or decline a leave request'),

            (CREATE_TRAINING, 'create a training'),
            (VIEW_TRAINING, 'view a training'),
            (UPDATE_TRAINING, 'update a training'),
            (LIST_TRAININGS, 'list all trainings'),
            (DELETE_TRAINING, 'delete a training'),
            (LIST_TRAINING_ATTENDEES, 'list all training attendees'),
            (MARK_TRAINING_ATTENDEE_PRESENT, 'mark a training attendee as present'),
            (ADD_TRAINING_ATTENDEE, 'add a training attendee'),
            (REMOVE_TRAINING_ATTENDEE, 'remove a training attendee'),
            (SET_ATTENDANCE_STATUS, 'set the attendance status of a training'),

            (LIST_OUTFLOW_HISTORY, 'list inflow audit trail'),
            (LIST_INFLOW_HISTORY, 'list outflow audit trail'),
