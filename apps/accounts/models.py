...
from apps.shared.literals import (
    ...
    DELETE_FARM_PRODUCTS, DELETE_GROUPS_AND_ROLES, DELETE_INFLOW_ORDER, DELETE_OUTFLOW_ORDER, DELETE_PRODUCT,
    ...
    LIST_INFLOW_ORDERS, LIST_INVOICES, LIST_OUTFLOW_APPROVAL, LIST_OUTFLOW_ORDERS, LIST_PAYBACKS, LIST_PRODUCTS,
    LIST_WAREHOUSES,
    ...
    UPDATE_INFLOW_ORDER, UPDATE_OUTFLOW_ORDER, UPDATE_PAYBACK, UPDATE_PRODUCT, UPDATE_WAREHOUSE, UPLOAD_WAREHOUSES,
    VERIFY_OUTFLOW_AVAILABILITY, VIEW_CREDIT, VIEW_CUSTOMER, VIEW_FARM, VIEW_FARMER, VIEW_GROUPS_AND_ROLES,
    VIEW_INFLOW_ORDER, VIEW_INVOICE, VIEW_OUTFLOW_APPROVAL, VIEW_OUTFLOW_ORDER, VIEW_PRODUCT, VIEW_WAREHOUSE,
    VIEW_WAYBILL
)
...
class User(AbstractUser, BaseModel, PermissionsMixin):
    ...
    class Meta:
        permissions = [
            ...
            (DOWNLOAD_WAYBILL, 'download a waybill'),
            (LIST_INVOICES, 'list all invoices'),
            (VIEW_INVOICE, 'view a invoice'),
            (DOWNLOAD_INVOICE, 'download a invoice'),
        ]
