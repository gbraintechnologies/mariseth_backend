...
from apps.shared.literals import (
    ...
    CREATE_OR_UPDATE_SETTINGS, CREATE_OUTFLOW_ORDER, CREATE_PAYBACK, CREATE_PRODUCT, CREATE_WAREHOUSE, DELETE_ADMIN,
    DELETE_CREDIT,
    DELETE_CUSTOMER, DELETE_CUSTOM_TYPE, DELETE_FARM, DELETE_FARMER, DELETE_FARM_PRODUCTS, DELETE_GROUPS_AND_ROLES,
    DELETE_INFLOW_ORDER, DELETE_OUTFLOW_ORDER, DELETE_PRODUCT, DELETE_WAREHOUSE, GET_SMALLHOLDERS_BY_LEAD, LIST_ADMINS,
    LIST_CREDITS,
    LIST_CUSTOMERS, LIST_FARMERS, LIST_FARMS, LIST_INFLOW_ORDERS, LIST_OUTFLOW_ORDERS, LIST_PAYBACKS, LIST_PRODUCTS,
    LIST_WAREHOUSES,
    MARK_OUTFLOW_COMPLETE, MARK_OUTFLOW_DELIVERED, MARK_OUTFLOW_ORDER_PICKED, RECORD_OUTFLOW_PAYMENT, UPDATE_ADMIN,
    UPDATE_CREDIT, UPDATE_CUSTOMER,
    UPDATE_CUSTOM_TYPE,
    UPDATE_FARM,
    UPDATE_FARMER,
    UPDATE_GROUPS_AND_ROLES, UPDATE_INFLOW_ORDER, UPDATE_OUTFLOW_ORDER, UPDATE_PAYBACK, UPDATE_PRODUCT,
    UPDATE_WAREHOUSE, UPLOAD_WAREHOUSES,
    VERIFY_OUTFLOW_AVAILABILITY, VIEW_CREDIT, VIEW_CUSTOMER, VIEW_FARM, VIEW_FARMER, VIEW_GROUPS_AND_ROLES,
    VIEW_INFLOW_ORDER, VIEW_OUTFLOW_APPROVAL,
    VIEW_OUTFLOW_ORDER,
    VIEW_PRODUCT,
    VIEW_WAREHOUSE
)
