...
from apps.shared.literals import (
    ...
    CREATE_GROUPS_AND_ROLES, CREATE_INFLOW_ORDER, CREATE_JOB_TITLE, CREATE_LEAVE_REQUEST,
    ...
    DELETE_JOB_TITLE, DELETE_LEAVE_REQUEST, DELETE_LEAVE_TYPE, DELETE_OUTFLOW_ORDER,
    ...
    LIST_CUSTOMERS, LIST_DEPARTMENTS, LIST_EMPLOYEES, LIST_EMPLOYEE_DISCIPLINARY_ACTIONS,
    ...
    UPDATE_INFLOW_ORDER, UPDATE_JOB_TITLE, UPDATE_LEAVE_REQUEST, UPDATE_LEAVE_TYPE,
    ...
    VIEW_PRODUCT, VIEW_TRAINING, VIEW_WAREHOUSE, VIEW_WAYBILL
)
