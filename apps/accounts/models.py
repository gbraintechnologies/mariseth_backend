...
from apps.shared.literals import (
    ADD_ADMIN, ADD_EMPLOYEE_DISCIPLINARY_ACTION, ADD_EMPLOYEE_QUALIFICATION, ADD_REMOVE_WAREHOUSE_MANAGER,
    APPROVE_INFLOW_DELIVERY_INSPECTION,
    APPROVE_INFLOW_ORDER,
    APPROVE_OR_DENY_CREDIT, ASSIGN_DELIVERY_INFO,
    CREATE_CREDIT, CREATE_CUSTOMER, CREATE_CUSTOM_TYPE, CREATE_DEPARTMENT, CREATE_EMPLOYEE, CREATE_FARM, CREATE_FARMER,
    CREATE_GROUPS_AND_ROLES,
    CREATE_INFLOW_ORDER, CREATE_JOB_TITLE, CREATE_OR_UPDATE_SETTINGS, CREATE_OUTFLOW_ORDER, CREATE_PAYBACK,
    CREATE_PRODUCT,
    CREATE_WAREHOUSE, DELETE_ADMIN, DELETE_CREDIT, DELETE_CUSTOMER, DELETE_CUSTOM_TYPE, DELETE_DEPARTMENT,
    DELETE_EMPLOYEE, DELETE_FARM,
    DELETE_FARMER,
    DELETE_FARM_PRODUCTS, DELETE_GROUPS_AND_ROLES, DELETE_INFLOW_ORDER, DELETE_JOB_TITLE, DELETE_OUTFLOW_ORDER,
    DELETE_PRODUCT,
    DELETE_WAREHOUSE, DOWNLOAD_INVOICE, DOWNLOAD_WAYBILL, GET_FARMER_CREDIT_HISTORY, GET_PRODUCT_MOVEMENT,
    GET_PRODUCT_WAREHOUSE_MOVEMENT,
    GET_SMALLHOLDERS_BY_LEAD,
    GET_WAREHOUSE_INVENTORY, LIST_ADMINS,
    LIST_CREDITS, LIST_CUSTOMERS,
    LIST_DEPARTMENTS, LIST_EMPLOYEES, LIST_EMPLOYEE_DISCIPLINARY_ACTIONS, LIST_EXPENSES, LIST_FARMERS, LIST_FARMS,
    LIST_INFLOW_ORDERS, LIST_INVOICES, LIST_JOB_TITLES, LIST_OUTFLOW_APPROVAL, LIST_OUTFLOW_ORDERS, LIST_PAYBACKS,
    LIST_PRODUCTS,
    LIST_WAREHOUSES,
    LIST_WAYBILLS, MARK_OUTFLOW_COMPLETE, MARK_OUTFLOW_DELIVERED, MARK_OUTFLOW_ORDER_PICKED, RECORD_OUTFLOW_PAYMENT,
    REMOVE_EMPLOYEE_QUALIFICATION, UPDATE_ADMIN,
    UPDATE_CREDIT, UPDATE_CUSTOMER, UPDATE_CUSTOM_TYPE, UPDATE_DEPARTMENT, UPDATE_EMPLOYEE, UPDATE_FARM, UPDATE_FARMER,
    UPDATE_GROUPS_AND_ROLES,
    UPDATE_INFLOW_ORDER, UPDATE_JOB_TITLE, UPDATE_OUTFLOW_ORDER, UPDATE_PAYBACK, UPDATE_PRODUCT, UPDATE_WAREHOUSE,
    UPLOAD_WAREHOUSES,
    VERIFY_OUTFLOW_AVAILABILITY, VIEW_CREDIT, VIEW_CUSTOMER, VIEW_DEPARTMENT, VIEW_EMPLOYEE, VIEW_FARM, VIEW_FARMER,
    VIEW_GROUPS_AND_ROLES,
    VIEW_INFLOW_ORDER, VIEW_INVOICE, VIEW_JOB_TITLE, VIEW_OUTFLOW_APPROVAL, VIEW_OUTFLOW_ORDER, VIEW_PRODUCT,
    VIEW_WAREHOUSE,
    VIEW_WAYBILL
)
