...
from apps.shared.literals import (
    ...
    DELETE_INPUT_CREDIT, DELETE_JOB_TITLE, DELETE_LEAVE_REQUEST, DELETE_LEAVE_TYPE, DELETE_OUTFLOW_ORDER,
    ...
    VIEW_GROUPS_AND_ROLES, VIEW_INFLOW_APPROVAL, VIEW_INFLOW_ORDER, VIEW_INVOICE, VIEW_JOB_TITLE,
