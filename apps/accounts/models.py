...
from apps.shared.literals import (
    ...
    DELETE_WAREHOUSE, DOWNLOAD_WAYBILL, GET_FARMER_CREDIT_HISTORY, GET_PRODUCT_MOVEMENT, GET_PRODUCT_WAREHOUSE_MOVEMENT,
    ...
    VIEW_INFLOW_ORDER, VIEW_OUTFLOW_APPROVAL, VIEW_OUTFLOW_ORDER, VIEW_PRODUCT, VIEW_WAREHOUSE, VIEW_WAYBILL
)
