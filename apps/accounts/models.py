...
from apps.shared.literals import (
    ...
    CREATE_GROUPS_AND_ROLES, CREATE_INFLOW_ORDER, CREATE_INPUT_CREDIT, CREATE_INPUT_CREDIT_PURCHASE, CREATE_JOB_TITLE,
    ...
    DELETE_FARMER, DELETE_FARM_PRODUCTS, DELETE_GROUPS_AND_ROLES, DELETE_INFLOW_ORDER,
    DELETE_INPUT_CREDIT, DELETE_INPUT_CREDIT_PURCHASE, DELETE_JOB_TITLE, DELETE_LEAVE_REQUEST, DELETE_LEAVE_TYPE, DELETE_OUTFLOW_ORDER,
    ...
    UPDATE_INFLOW_ORDER, UPDATE_INPUT_CREDIT, UPDATE_JOB_TITLE, UPDATE_LEAVE_REQUEST, UPDATE_LEAVE_TYPE,
