...
from apps.shared.literals import (
    ...
    LIST_EXPENSES, LIST_FARMERS, LIST_FARMS, LIST_INFLOW_APPROVALS, LIST_INFLOW_ORDERS, LIST_INVOICES,
    LIST_JOB_TITLES, LIST_LEAVE_REQUESTS, LIST_LEAVE_TYPES, LIST_OUTFLOW_APPROVAL,
    LIST_OUTFLOW_ORDERS, LIST_PAYBACKS, LIST_PRODUCTS, LIST_TRAININGS,
